...
\end{eqnarray}
よって、$C_1,C_2$が交点をもつi.e.上の式で$y$座標が実数になる範囲は
\begin{equation}
\begin{cases}
      & 1= |v| \text{ かつ } |w|= 1, \\
      &   1 < |v| \text{ かつ } |w| < 1, \\
...
\end{cases}
\end{equation}
の３つの場合である。１番目は,円が接している場合,2番目は、半径の和が中心の距離より大きく、且つ、その差が2以下であるという場合,３番目は,半径の和が中心の距離よりも小さく且つその差が2以上であるという条件であるが,これは$r_1, r_2>0$のため不可能である.よって、2円$C_1,C_2$の交点の座標は$(x,y)=(vw,\pm\sqrt{ (v^2 -1)( 1-w^2 ) })$であることがわかった.\\
