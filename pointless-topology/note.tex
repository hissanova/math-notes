...
\begin{align*}
  c \wedge a \le b \Rightarrow \neg a \vee b &\ge \neg a \vee (a \wedge c) \\
                                             ...
                                             &\ge c.
\end{align*}
Thus $\neg a \vee b$ is the unique largest element $c$ satisfying $c \wedge z \le b$. A lattice $A$ is said to be a \itbf{Heyting algebra} if, for each pair of elements $(a,b)$, there exists an element $(a \rightarrow b)$ such that $c\le(a\rightarrow b)$ iff $c \wedge a \le b$.
\begin{lemma}
